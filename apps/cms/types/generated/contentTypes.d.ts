...
export interface ApiAlumnusAlumnus extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Directory of school alumni';
    displayName: 'Alumnus';
    pluralName: 'alumni';
  ...
  attributes: {
    ...
    scrapingStatus: Schema.Attribute.Enumeration<
      ['pending', 'processing', 'scraped', 'error']
    > &
...
export interface ApiBulkImportBulkImport extends Struct.CollectionTypeSchema {
  collectionName: 'bulk_imports';
  info: {
    description: 'Upload a CSV to import alumni';
    displayName: 'Bulk Import';
    pluralName: 'bulk-imports';
    singularName: 'bulk-import';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    csvFile: Schema.Attribute.Media & Schema.Attribute.Required;
...
export interface ApiConfigurationConfiguration extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Control scraping frequency and history';
...
export interface ApiPromotionPromotion extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Student years (e.g., 2024, 2025)';
  ...
  attributes: {
    alumni: Schema.Attribute.Relation<'oneToMany', 'api::alumnus.alumnus'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSectorSector extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Industry sectors (e.g., Tech, Finance, Healthcare)';
    displayName: 'Sector';
    pluralName: 'sectors';
    singularName: 'sector';
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::bulk-import.bulk-import': ApiBulkImportBulkImport;
